...
#
# This package is probably leaking memory at the moment, since the Fortran routines
...
function lfmm2dparttarg(iprec::Int64,
    ...
    pottarg = Array{Complex128}(ntarget)
    gradtarg = Array{Complex128}(2, ntarget)
    hesstarg = Array{Complex128}(3, ntarget)
    # Library call
